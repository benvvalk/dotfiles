...
(fn NAME &key CURL-ARGS HEADER KEY REQUEST-PARAMS (STREAM nil) (HEADER (lambda nil (when-let* ((key (gptel--get-api-key))) \\=`((\"X-goog-api-key\" \\=\\, key))))) (HOST \"generativelanguage.googleapis.com\") (PROTOCOL \"https\") (MODELS gptel--gemini-models) (ENDPOINT \"/v1beta/models\"))")
